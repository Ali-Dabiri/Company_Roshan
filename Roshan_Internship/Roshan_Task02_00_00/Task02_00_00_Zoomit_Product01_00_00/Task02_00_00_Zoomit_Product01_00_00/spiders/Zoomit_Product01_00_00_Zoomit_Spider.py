...
class ZoomitProduct010000ZoomitSpiderSpider(scrapy.Spider):
    name = "Zoomit_Product01_00_00_Zoomit_Spider"
    ...
    def parse(self, response):
        ...
        all_product_search = response.xpath("//div[2]/form/div/div[3]/div/div[2]/div[2]/div[3]")

        product_name = all_product_search.xpath(".//a/span/text()").getall()
        product_price = all_product_search.xpath(".//p/span/text()").getall()
        product_score = all_product_search.xpath(".//div[@class='fa leading-none']/text()").getall()
